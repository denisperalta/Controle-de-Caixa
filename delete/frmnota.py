...
# Form implementation generated from reading ui file 'frmnota.ui'
#
...
class Ui_frmconta(object):
    def setupUi(self, frmconta):
        ...
        self.label_3.setGeometry(QtCore.QRect(20, 103, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.txtvalor = QtWidgets.QLineEdit(self.groupBox)
        self.txtvalor.setEnabled(True)
        self.txtvalor.setGeometry(QtCore.QRect(140, 100, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.txtvalor.setFont(font)
        self.txtvalor.setObjectName("txtvalor")
        self.dateEdit = QtWidgets.QDateEdit(self.groupBox)
        self.dateEdit.setGeometry(QtCore.QRect(140, 60, 121, 31))
        ...
        frmconta.setTabOrder(self.btnnovo, self.btnguardar)
        ...
        frmconta.setTabOrder(self.tabla, self.txtvalor)

    def retranslateUi(self, frmconta):
        _translate = QtCore.QCoreApplication.translate
        frmconta.setWindowTitle(_translate("frmconta", "Registro de Notas"))
        ...
        self.label_2.setText(_translate("frmconta", "Dia"))
        self.btncancelar.setText(_translate("frmconta", "Cancelar"))
        self.label_3.setText(_translate("frmconta", "Total das Notas:"))
